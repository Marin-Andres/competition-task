...
export default class EmployeeProfile extends React.Component {
    ...
    loadData() {
        ...
        $.ajax({
            url: 'https://talentservicesprofile-fph9ckfqh4gseace.australiasoutheast-01.azurewebsites.net/profile/profile/getEmployerProfile',
            headers: {
    ...
    saveData() {
        ...
        var cookies = Cookies.get('talentAuthToken');
        $.ajax({
            url: 'https://talentservicesprofile-fph9ckfqh4gseace.australiasoutheast-01.azurewebsites.net/profile/profile/saveEmployerProfile',
            headers: {
                'Authorization': 'Bearer ' + cookies,
                'Content-Type': 'application/json'
            },
