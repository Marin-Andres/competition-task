...
export default class ResetPassword extends React.Component {
    ...
    checkToken(email, token) {
        ...
        let url = `https://talentservicesidentity-eeasf2b6byg2b5ga.australiasoutheast-01.azurewebsites.net/authentication/authentication/verifyResetPasswordToken?o=${email}&p=${token}`;
        $.ajax({
            url: url,
            type: 'POST',
    ...
    savePassword() {
        ...
        let resetUrl = `https://talentservicesidentity-eeasf2b6byg2b5ga.australiasoutheast-01.azurewebsites.net/authentication/authentication/resetpassword?o=${email}&p=${token}`;
