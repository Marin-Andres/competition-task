...
export default class VerifyClient extends React.Component {
    ...
    checkToken(recruiterEmail, clientEmail, resetPasswordToken) {
        ...
        let url = `https://talentservicesidentity-eeasf2b6byg2b5ga.australiasoutheast-01.azurewebsites.net/authentication/authentication/verifyClientToken?recruiterEmail=${recruiterEmail}&clientEmail=${clientEmail}&resetPasswordToken=${resetPasswordToken}`;
        $.ajax({
            url: url,
            type: 'POST',
    ...
    savePassword() {
        ...
        let resetUrl = `https://talentservicesidentity-eeasf2b6byg2b5ga.australiasoutheast-01.azurewebsites.net/authentication/authentication/validateInvitation?recruiterEmail=${recruiterEmail}&clientEmail=${clientEmail}&resetPasswordToken=${resetPasswordToken}`;
